...
namespace Mine.Services
{
    class DatabaseService : IDataStore<ItemModel>
    {
        ...
        /// </summary>
        /// <param name="item"></param>
        /// <returns>if Item is not null and existed in Database returns true otherwise returns false</returns>
        ...
        /// <summary>
        /// Delete an Item in Database using its ID
        /// </summary>
        /// <param name="id"></param>
        /// <returns>if ID is valid and item existed in Database returns true otherwise returns false</returns>
